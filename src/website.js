...
function navBar () {
    ...
    theNavBar.className = "navbar navbar-expand-lg bg-body-tertiary";
    navContainer = document.createElement("div");
    navContainer.className = "container-fluid";
    theNavBar.appendChild(navContainer)
    navTitle = document.createElement("a");
    navTitle.className = "navbar-brand";
    navTitle.innerText = "JS-todo";
